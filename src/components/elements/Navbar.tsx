...
const navItems = [
  ...
  {href: "#fearures", text: "Características"},
]
        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div className="min-w-max inline-flex relative">
            <a href="/" className="relative flex items-center gap-3">
              <img src={logo} alt="iAmigo logo" className="w-10 h-10"/>
          ...
          lg:bg-transparent border-x border-x-box-border lg:border-x-0 lg:h-auto">
